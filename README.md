...
한국 상장사 ESG 데이터를 AI 에게 바로 물어볼 수 있게 하는 MCP 서버 <br>
...
> 번들마다 어느 커밋으로 만들었는지 적힌 `BUILD_INFO.txt` 가 들어 있습니다.
...
<details open>
<summary><b>📊 ESG 등급이 궁금할 때</b></summary>

> - 삼성전자 ESG 등급 알려줘
> - 현대차랑 기아 ESG 등급 비교해줘
> - LG화학 KCGS 등급 3년 추이 보여줘
> - SK하이닉스 등급, 같은 기관, 같은 업종 안에서는 어느 정도 위치야?
...
⭐ 별표 하나와 후원은 유지·보수에 큰 힘이 됩니다. <br>
<sub>(문서 맨 위의 별 배지는 링크일 뿐이라 눌러도 star 가 되지 않습니다 — 페이지 **우측 상단의 ⭐ Star** 버튼을 눌러 주세요.)</sub>
